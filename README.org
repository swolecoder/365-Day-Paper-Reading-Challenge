...
86. Improve Document Embedding for Text Categorization Through Deep Siamese Neural Network
87. Sentence-BERT: Sentence Embeddings using Siamese BERT-Networks
88. Lessons Learned from Applying off-the-shelf BERT: There is no Silver Bullet
89. Fast Logistic Regression for Text Categorization with Variable-Length N-grams
90. FaceNet: A Uniﬁed Embedding for Face Recognition and Clustering
91. Towards Accurate Duplicate Bug Retrieval using Deep Learning Techniques
92. Deeper Text Understanding for IR with Contextual Neural Language Modeling
93. Automatically Repairing Programs Using Both Tests and Bug Reports